...
Postiz com a marca Stratechna.
    ...
    ghcr.io/stratechna/stratechna-social:2.21        ← o que a produção usa
    ghcr.io/stratechna/stratechna-social:2.21.6      ← versão exacta
...
5. **Teste antes de publicar.** `branding/verificar.sh` arranca a imagem com PostgreSQL e
   Redis e verifica o login, os bundles servidos, os ficheiros próprios e as protecções.
...
`/opt/stratechna/postiz/docker-compose.yml`: imagem `stratechna-social:2.21`, sem ficheiros
